			...
			{!file ? (
				...
				<div className='relative flex flex-col items-center'>
					...
					<div className='absolute top-0 left-0 w-full h-full flex justify-center items-center'>
						...
						>
							<Translation translationKey='imageInp_replace' />
						</label>
						<input
							id='file'
							type='file'
