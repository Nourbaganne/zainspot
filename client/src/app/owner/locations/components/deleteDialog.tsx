            ...
            <div className="bg-white rounded-xl pb-6 pt-4 px-9 w-full max-w-[100vh] relative shadow-lg flex flex-col gap-5 ">
                <div className='flex justify-center items-center'>
                    <h1 className='font-bold text-[32px] text-center'>
                        <Translation translationKey='Delete Location' />
                    </h1>
                ...
                <p className='font-regular text-span font-light text-center'>
                    <Translation translationKey='deleteLocation_desc' />
                </p>
                <div className='flex flex-col gap-4'>
                    <h1 className='font-regular text-span font-light text-sm'>
                        <Translation translationKey='deleteLocation_confirmation' />
                    </h1>
                    <div className='grid grid-cols-4 gap-3'>
                        <input
                            ...
                            className='border rounded-md p-2 col-span-3 border-button text-span outline-none focus:ring-0 focus:border-button '
                            placeholder='Delete'
                        ...
                        >
                            <Translation translationKey='deleteLocation_btn' />
                        </button>
                    </div>
                </div>
            </div>
