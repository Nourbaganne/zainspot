    ...
    <div className='flex flex-col gap-6 bg-background-foreground px-4 md:px-24 py-4 md:py-8 md:pb-20'>
      ...
      <div className='w-full pl-2 md:pl-0'>
        ...
        <div className='mt-4 flex flex-col gap-4 md:flex-row justify-between md:items-center'>
          ...
          <div className='bg-span-background flex flex-wrap text-span-foreground rounded-md p-2 gap-2'>
            <div className='flex gap-2 md:font-semibold whitespace-nowrap overflow-x-auto'>
              {FILTERING_TYPE.map((filter, index) => (
                <div
                  key={index}
                  className={`px-3 py-2 rounded-md cursor-pointer text-sm md:text-base ${selectedFilter === filter.value
