...
import { CURRENCIES_DATA, LANGUAGES_DATA } from '@/app/constants/navbar'
...
const ProfileDetailsForm: React.FC<ProfileDetailsFormProps> = ({ userDetails }) => {
    const formik = useUpdateForm(userDetails);
