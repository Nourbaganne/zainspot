	...
	return (
		<div className='flex flex-col gap-4 text-text'>
			<div className='grid grid-cols-2 md:grid-cols-8 gap-2'>
				...
				<div className='md:col-span-5 flex flex-col gap-3'>
					...
					<div className='hidden text-sm md:flex gap-2'>
						<h1 className='font-semibold'>
							<Translation translationKey='subscriptions_adr' />
						</h1>
					...
					{user?.businessNumber && (
						<div className='text-sm hidden md:flex gap-2'>
							<h1 className='font-semibold'>
								<Translation translationKey='subscriptions_localPhone' />
							</h1>
				...
				<div className='md:items-end col-span-2 md:col-span-1 flex flex-row md:flex-col justify-between capitalize'>
					<div>
						<h1 className='font-semibold'>{optionType}</h1>
						<p className='text-xs text-span'>
							{duration}&nbsp;
							<Translation translationKey='monthly' />
						</p>
					</div>
			...
			<div className='flex flex-col md:flex-row md:justify-between gap-4 md:gap-0 text-sm'>
				<div className='flex flex-col'>
					<div className='flex gap-1'>
						<h1>
							<Translation translationKey='subscriptions_start' />
						</h1>
					...
					<div className='flex gap-1'>
						<h1>
							<Translation translationKey='subscriptions_end' />
						</h1>
						<p className='font-light'>
				...
				{/* <div className='text-xs font-semibold flex flex-col md:flex-row gap-3'>
                    <button onClick={handleCancelSubscription} className='p-3 rounded-md border-2 border-button text-button-text'>
                        <Translation translationKey='subscriptions_cancel' />
                    </button>
                    <button className='p-3 rounded-md border-2 border-primary text-primary'>
                        <Translation translationKey='subscriptions_edit' />
                    </button>
                </div> */}
			</div>
		</div>
