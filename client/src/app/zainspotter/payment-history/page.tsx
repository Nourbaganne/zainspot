			...
			<Layout>
				<div className='flex flex-col p-4 px-6 gap-4 bg-background border pb-10 mb-20'>
					<h1 className='font-bold'>
						<Translation translationKey='paymentHistory_header' />
					</h1>
					<div className='overflow-x-auto'>
						{data?.data.length > 0 ? (
							<div className='min-w-max'>
								<div className='grid grid-cols-11 bg-background-foreground text-span text-sm items-center pl-2 py-3 sticky top-0'>
									<h1 className='col-span-3'>
										<Translation translationKey='paymentHistory_subs' />
									</h1>
									<div className='col-span-2 flex items-center gap-2'>
										...
										<h1>
											<Translation translationKey='paymentHistory_date' />
										</h1>
									</div>
									<div className='col-span-2'>
										<h1>
											<Translation translationKey='paymentHistory_method' />
										</h1>
									</div>
									<div className='col-span-2 flex items-center gap-2'>
										<div className='flex flex-col gap-1'>
										...
										<h1>
											<Translation translationKey='paymentHistory_amount' />
										</h1>
									</div>
									<div className='col-span-2 flex items-center gap-2'>
										<div className='flex flex-col gap-1'>
										...
										<h1>
											<Translation translationKey='paymentHistory_status' />
										</h1>
									</div>
								</div>
							...
							<div>
								<Translation translationKey='paymentHistory_empty' />
							</div>
						)}
					</div>
				</div>
				...
				<Portal>
					...
					>
						<h1 className='font-semibold'>
							<Translation translationKey='paymentHistory_manually' />
						</h1>
						<p className='flex flex-col text-sm max-w-xs'>
							<Translation translationKey='paymentHistory_desc' />
							<span>
								<Translation translationKey='paymentHistory_span' />
							</span>
						</p>
						<div className='flex gap-3 font-normal text-xs justify-end'>
							...
							>
								<Translation translationKey='paymentHistory_cancel' />
							</button>
							<button className='py-2 px-4 bg-primary text-background rounded-md'>
								<Translation translationKey='paymentHistory_btn' />
							</button>
						</div>
					</div>
				</Portal>
