				...
				<div className='flex flex-col p-4 px-6 gap-4 bg-background border pb-10 mb-20'>
					...
					<div className='overflow-x-auto'>
						{data?.data.length > 0 ? (
							<div className='min-w-max'>
								<div className='grid grid-cols-11 bg-background-foreground text-span text-sm items-center pl-2 py-3 sticky top-0'>
									<h1 className='col-span-3 '>
										<Translation translationKey='invoices_header' />
									</h1>
									<div className='col-span-2 flex items-center gap-2'>
										...
										<h1>
											<Translation translationKey='invoices_issuedDate' />
										</h1>
									</div>
									<div className='col-span-2 flex items-center gap-2'>
										<div className='flex flex-col gap-1'>
										...
										<h1>
											<Translation translationKey='invoices_dueDate' />
										</h1>
									</div>
									<div className='col-span-2 flex items-center gap-2'>
										<div className='flex flex-col gap-1'>
										...
										<h1>
											<Translation translationKey='invoices_amount' />
										</h1>
									</div>
									<div className='col-span-2 flex items-center gap-2'>
										<div className='flex flex-col gap-1'>
										...
										<h1>
											<Translation translationKey='invoices_status' />
										</h1>
									</div>
								</div>
									...
									{data?.data.map((invoice: Invoice, index: number) => (
										...
										>
											...
											>
												...
												<li
													className={`col-span-2 pl-4 flex items-center gap-2 uppercase ${invoice.status === 'paid'
														? 'text-primary'
												...
												>
													<span
														className={`w-3 h-3 rounded-full ${invoice.status === 'paid'
															? 'bg-primary'
															: invoice.status === 'unpaid'
																? 'bg-yellow-500'
																: 'bg-alert'
							...
							<div>
								<Translation translationKey='invoices_empty' />
							</div>
						)}
					</div>
				</div>
