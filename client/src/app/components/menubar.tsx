...
import openLeftMenu from '../assets/navbar/openLeftMenu.svg';
import closeLeftMenu from '../assets/navbar/closeLeftMenu.svg';
	...
	return (
		...
		>
			...
			<div className='flex flex-col gap-3'>
				{user ? (
					<button
						className='text-alert text-lg font-semibold'
