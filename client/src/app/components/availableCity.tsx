...
const AvailableCity = ({ city, index }: { city: City; index: number }) => {
  return (
    <Link
      ...
      className={`relative flex bg-secondary-foreground hover:bg-background gap-4 items-center cursor-pointer group hover:shadow-lg `}
      key={index}
    >
      ...
      <div className="flex flex-col gap-2">
        <h1 className="font-semibold font-sans text-text-foreground">
          <Translation translationKey="city_directionText" />
          {" "}{city.city}
        </h1>
