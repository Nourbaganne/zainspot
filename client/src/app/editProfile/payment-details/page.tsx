        ...
        <Layout>
            ...
            <div className='col-span-6 flex flex-col p-4 px-6 gap-3 bg-background border'>
                ...
                <p className='p-2 bg-alert-foreground border text-span text-sm py-4'>
                    You haven't verified your email. To subscribe and make purchases, please <span className='text-secondary cursor-pointer hover:underline'> verify your email.</span>
                </p>
                <form action="">
                            ...
                            <div className=" col-span-2 flex flex-col gap-2 w-full">
                                <div className="relative flex flex-col w-full">
                                    <select
                                        ...
                                        onChange={formik.handleChange}
                                        className={`border px-2 py-3 rounded-md peer focus:outline-none focus:ring-0 ${formik.errors.businessType && formik.touched.businessType
                                            ? "border-alert"
                                            : "border-button focus:border-primary"
                                            }`}
                                    >
