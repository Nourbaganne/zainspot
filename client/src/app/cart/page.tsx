...
const Page = () => {
    ...
    return (
        <Container
            ...
            <div className='bg-background pt-8 px-5 md:px-20 pb-20 flex flex-col gap-8 items-start'>
                ...
                {["12", "6", "3"].map(duration => {
                    ...
                    return cities.length > 0 && (
                        <div key={duration} className='flex flex-col gap-4 w-full'>
                            ...
                            <div className='grid grid-cols-8 border-b pb-3 text-span font-regular border-span-background '>
                                <p className='col-span-4'>City</p>
                                <p className='col-span-2'>Subscription</p>
                                <p className='col-span-2 text-end pr-[74px]'>Subtotal</p>
                            </div>
                                    ...
                                    <div key={index} className='border-b border-span-background grid grid-cols-8 justify-center items-center pb-4'>
                                        <div className='col-span-4 flex gap-4 items-center'>
                                            ...
                                            <div className='flex flex-col gap-1 '>
                                                ...
                                                <p className='text-span font-sans font-thin'>{city.cityAdress}</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className='col-span-2 flex justify-end gap-14 items-center'>
