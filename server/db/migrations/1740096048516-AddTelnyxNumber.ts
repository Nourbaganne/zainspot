...
export class AddTelnyxNumber1740096048516 implements MigrationInterface {
    name = 'AddTelnyxNumber1740096048516'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`subscription\` ADD \`telnyxNumber\` varchar(255) NULL`);
