...
export class FirstMigration1737452978203 implements MigrationInterface {
    name = 'FirstMigration1737452978203'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`visitor\` (\`id\` int NOT NULL AUTO_INCREMENT, \`visitorId\` varchar(255) NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), UNIQUE INDEX \`IDX_037234bfa900a5b4bdde6f86da\` (\`visitorId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`invoice\` (\`id\` int NOT NULL AUTO_INCREMENT, \`dateIssued\` datetime NOT NULL, \`dueDate\` datetime NOT NULL, \`amount\` decimal NOT NULL, \`status\` varchar(255) NOT NULL, \`paymentHistoryId\` int NULL, \`userId\` int NULL, UNIQUE INDEX \`REL_5318cc339ff1bc8c6085323602\` (\`paymentHistoryId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`payment_history\` (\`id\` int NOT NULL AUTO_INCREMENT, \`date\` datetime NOT NULL, \`method\` varchar(255) NULL, \`amount\` decimal NOT NULL, \`status\` varchar(255) NOT NULL, \`stripeSessionId\` varchar(255) NULL, \`userId\` int NULL, \`subscriptionId\` int NULL, UNIQUE INDEX \`REL_3309cd631d6c3263c550d19ff1\` (\`subscriptionId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`user\` (\`id\` int NOT NULL AUTO_INCREMENT, \`email\` varchar(255) NOT NULL, \`isEmailConfirmed\` tinyint NOT NULL DEFAULT 0, \`password\` varchar(255) NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`businessNumber\` varchar(255) NULL, \`businessName\` varchar(255) NOT NULL, \`tradeName\` varchar(255) NOT NULL, \`businessType\` varchar(255) NOT NULL, \`country\` varchar(255) NOT NULL, \`city\` varchar(255) NOT NULL, \`businessWebsite\` varchar(255) NOT NULL DEFAULT 'Unknown', \`state\` varchar(255) NOT NULL, \`zipCode\` varchar(255) NOT NULL, \`fullStreetAdress\` varchar(255) NOT NULL, \`name\` varchar(255) NOT NULL, \`middleName\` varchar(255) NOT NULL DEFAULT '', \`lastName\` varchar(255) NOT NULL, \`gender\` varchar(255) NOT NULL, \`birthday\` date NULL, \`mediaProfile\` varchar(255) NULL DEFAULT '', \`recaptcha\` varchar(255) NOT NULL DEFAULT '', \`stripeCustomerId\` varchar(255) NULL, \`activation\` tinyint NOT NULL DEFAULT 1, \`EmailAuthentication\` tinyint NOT NULL DEFAULT 0, \`twoFactorCode\` varchar(255) NULL, \`twoFactorCodeExpiresAt\` timestamp NULL, \`suiteNumber\` varchar(255) NULL, \`preferedLanguage\` varchar(255) NOT NULL DEFAULT 'AR', \`preferedCurrency\` varchar(255) NOT NULL DEFAULT 'USD', \`roleId\` int NULL, UNIQUE INDEX \`IDX_e12875dfb3b1d92d7d7c5377e2\` (\`email\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`subscription\` (\`id\` int NOT NULL AUTO_INCREMENT, \`startDate\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`endDate\` datetime NOT NULL, \`optionType\` varchar(255) NOT NULL, \`duration\` int NOT NULL, \`price\` int NOT NULL, \`renewalDate\` datetime NULL, \`renewalStatus\` varchar(255) NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`userId\` int NULL, \`cityId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
