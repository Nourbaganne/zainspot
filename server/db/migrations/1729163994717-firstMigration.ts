...
export class FirstMigration1729163994717 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`subscription\` (\`id\` int NOT NULL AUTO_INCREMENT, \`startDate\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`endDate\` datetime NOT NULL, \`optionType\` varchar(255) NOT NULL, \`duration\` int NOT NULL, \`price\` int NOT NULL, \`renewalDate\` datetime NULL, \`renewalStatus\` varchar(255) NULL, \`userId\` int NULL, \`cityId\` int NULL, \`paymentId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`payment_history\` (\`id\` int NOT NULL AUTO_INCREMENT, \`date\` datetime NOT NULL, \`method\` varchar(255) NULL, \`amount\` decimal NOT NULL, \`status\` varchar(255) NOT NULL, \`stripeSessionId\` varchar(255) NULL, \`userId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`user\` (\`id\` int NOT NULL AUTO_INCREMENT, \`email\` varchar(255) NOT NULL, \`isEmailConfirmed\` tinyint NOT NULL DEFAULT 0, \`password\` varchar(255) NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`businessNumber\` varchar(255) NULL, \`businessName\` varchar(255) NOT NULL, \`tradeName\` varchar(255) NOT NULL, \`businessType\` varchar(255) NOT NULL, \`country\` varchar(255) NOT NULL, \`city\` varchar(255) NOT NULL, \`businessWebsite\` varchar(255) NOT NULL DEFAULT 'Unknown', \`state\` varchar(255) NOT NULL, \`zipCode\` varchar(255) NOT NULL, \`fullStreetAdress\` varchar(255) NOT NULL, \`interestRegion\` varchar(255) NOT NULL, \`name\` varchar(255) NOT NULL, \`middleName\` varchar(255) NOT NULL DEFAULT '', \`lastName\` varchar(255) NOT NULL, \`gender\` varchar(255) NOT NULL, \`birthday\` date NULL, \`mediaProfile\` varchar(255) NULL DEFAULT '', \`recaptcha\` varchar(255) NOT NULL DEFAULT '', \`imageUrl\` varchar(255) NULL, \`roleId\` int NULL, UNIQUE INDEX \`IDX_e12875dfb3b1d92d7d7c5377e2\` (\`email\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
